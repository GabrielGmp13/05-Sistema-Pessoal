# Histórico de tarefas — fotografia preservada em 2026-08-31

Este conteúdo era `docs/TASKS_NOW.md` antes da preparação da v0.2.0. Foi
movido integralmente, sem reclassificar resultados antigos. Datas, contagens e
declarações de conclusão abaixo são históricas, não a situação vigente.
Tarefas atuais: [TASKS_NOW.md](../TASKS_NOW.md).
...
- [x] Criação de Anime passa a exibir duas etapas explícitas no mesmo modal e,
      após salvar a obra-base, leva automaticamente a temporadas, músicas,
      complementos e ordem de consumo sem apresentar o fluxo como edição.
