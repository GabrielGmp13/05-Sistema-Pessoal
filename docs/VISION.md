...
| Biblioteca | ✅ Implementada (v2) | Catálogo consolidado em página única com sidebar (DEC-032), incluindo Vídeos e Artigos. O fluxo manual Vídeo → Curso e todas as migrations relacionadas estão em produção; restam apenas testes manuais e polimento final. Continua sendo catálogo, nunca hospedagem de mídia (DEC-011). |
