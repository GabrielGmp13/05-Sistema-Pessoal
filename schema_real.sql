...
CREATE TABLE IF NOT EXISTS "public"."animes_episodios" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."animes_episodios" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."animes_generos" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."animes_generos" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."animes_ordem_consumo" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "anime_uuid" "text" NOT NULL,
...
ALTER TABLE "public"."animes_ordem_consumo" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."animes_temporadas" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "anime_uuid" "text" NOT NULL,
    "numero" integer NOT NULL,
...
ALTER TABLE "public"."animes_temporadas" OWNER TO "postgres";
...
ALTER TABLE "public"."anotacoes_estudo" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."conteudos_materias" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."conteudos_materias" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."execucoes_cardio" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."execucoes_cardio" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."execucoes_forca" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "sessao_uuid" "text" NOT NULL,
    "exercicio_uuid" "text" NOT NULL,
...
ALTER TABLE "public"."execucoes_forca" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."exercicios_cardio" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."exercicios_cardio" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."exercicios_forca" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "treino_uuid" "text" NOT NULL,
    "nome" "text" NOT NULL,
...
ALTER TABLE "public"."exercicios_forca" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."filmes_generos" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."filmes_generos" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."livros_anotacoes" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."livros_anotacoes" OWNER TO "postgres";
...
ALTER TABLE "public"."livros_generos" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."mangas_generos" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."mangas_generos" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."mangas_volumes" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "manga_uuid" "text" NOT NULL,
    "numero" integer NOT NULL,
...
ALTER TABLE "public"."mangas_volumes" OWNER TO "postgres";
...
ALTER TABLE "public"."materiais_estudo" OWNER TO "postgres";
...
ALTER TABLE "public"."modulos_curso" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."modulos_treino" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "nome" "text" NOT NULL,
    "cor" "text",
...
ALTER TABLE "public"."modulos_treino" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."openings_endings" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "anime_uuid" "text" NOT NULL,
    "tipo" "text" NOT NULL,
...
ALTER TABLE "public"."openings_endings" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."podcasts_generos" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."podcasts_generos" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."questoes_individuais" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "materia_uuid" "text",
    "conteudo_uuid" "text",
...
ALTER TABLE "public"."questoes_individuais" OWNER TO "postgres";
...
ALTER TABLE "public"."redacoes" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."revisao_espacada" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."revisao_espacada" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."series_generos" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."series_generos" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."series_temporadas" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "serie_uuid" "text" NOT NULL,
    "numero" integer NOT NULL,
...
ALTER TABLE "public"."series_temporadas" OWNER TO "postgres";
...
ALTER TABLE "public"."sessoes_treino" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."trilha_sonora" (
    "uuid" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "tipo_obra" "text" NOT NULL,
    "obra_uuid" "text" NOT NULL,
...
ALTER TABLE "public"."trilha_sonora" OWNER TO "postgres";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."agenda" TO "anon";
GRANT ALL ON TABLE "public"."agenda" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."agenda" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes" TO "anon";
GRANT ALL ON TABLE "public"."animes" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_episodios" TO "anon";
GRANT ALL ON TABLE "public"."animes_episodios" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_episodios" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_generos" TO "anon";
GRANT ALL ON TABLE "public"."animes_generos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_generos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_ordem_consumo" TO "anon";
GRANT ALL ON TABLE "public"."animes_ordem_consumo" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_ordem_consumo" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_temporadas" TO "anon";
GRANT ALL ON TABLE "public"."animes_temporadas" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."animes_temporadas" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."anotacoes_estudo" TO "anon";
GRANT ALL ON TABLE "public"."anotacoes_estudo" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."anotacoes_estudo" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."atividades" TO "anon";
GRANT ALL ON TABLE "public"."atividades" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."atividades" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."conteudos" TO "anon";
GRANT ALL ON TABLE "public"."conteudos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."conteudos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."conteudos_materias" TO "anon";
GRANT ALL ON TABLE "public"."conteudos_materias" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."conteudos_materias" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."elenco" TO "anon";
GRANT ALL ON TABLE "public"."elenco" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."elenco" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."execucoes_cardio" TO "anon";
GRANT ALL ON TABLE "public"."execucoes_cardio" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."execucoes_cardio" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."execucoes_forca" TO "anon";
GRANT ALL ON TABLE "public"."execucoes_forca" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."execucoes_forca" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."exercicios_cardio" TO "anon";
GRANT ALL ON TABLE "public"."exercicios_cardio" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."exercicios_cardio" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."exercicios_forca" TO "anon";
GRANT ALL ON TABLE "public"."exercicios_forca" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."exercicios_forca" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."filmes" TO "anon";
GRANT ALL ON TABLE "public"."filmes" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."filmes" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."filmes_generos" TO "anon";
GRANT ALL ON TABLE "public"."filmes_generos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."filmes_generos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."generos" TO "anon";
GRANT ALL ON TABLE "public"."generos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."generos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."livros" TO "anon";
GRANT ALL ON TABLE "public"."livros" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."livros" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."livros_anotacoes" TO "anon";
GRANT ALL ON TABLE "public"."livros_anotacoes" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."livros_anotacoes" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."livros_generos" TO "anon";
GRANT ALL ON TABLE "public"."livros_generos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."livros_generos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mangas" TO "anon";
GRANT ALL ON TABLE "public"."mangas" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mangas" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mangas_generos" TO "anon";
GRANT ALL ON TABLE "public"."mangas_generos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mangas_generos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mangas_volumes" TO "anon";
GRANT ALL ON TABLE "public"."mangas_volumes" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mangas_volumes" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."materiais_estudo" TO "anon";
GRANT ALL ON TABLE "public"."materiais_estudo" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."materiais_estudo" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."materias" TO "anon";
GRANT ALL ON TABLE "public"."materias" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."materias" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."modulos_curso" TO "anon";
GRANT ALL ON TABLE "public"."modulos_curso" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."modulos_curso" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."modulos_treino" TO "anon";
GRANT ALL ON TABLE "public"."modulos_treino" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."modulos_treino" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."openings_endings" TO "anon";
GRANT ALL ON TABLE "public"."openings_endings" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."openings_endings" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."podcasts" TO "anon";
GRANT ALL ON TABLE "public"."podcasts" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."podcasts" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."podcasts_generos" TO "anon";
GRANT ALL ON TABLE "public"."podcasts_generos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."podcasts_generos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."provas" TO "anon";
GRANT ALL ON TABLE "public"."provas" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."provas" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."questoes_individuais" TO "anon";
GRANT ALL ON TABLE "public"."questoes_individuais" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."questoes_individuais" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."redacoes" TO "anon";
GRANT ALL ON TABLE "public"."redacoes" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."redacoes" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."revisao_espacada" TO "anon";
GRANT ALL ON TABLE "public"."revisao_espacada" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."revisao_espacada" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."series" TO "anon";
GRANT ALL ON TABLE "public"."series" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."series" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."series_generos" TO "anon";
GRANT ALL ON TABLE "public"."series_generos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."series_generos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."series_temporadas" TO "anon";
GRANT ALL ON TABLE "public"."series_temporadas" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."series_temporadas" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."sessoes_estudo" TO "anon";
GRANT ALL ON TABLE "public"."sessoes_estudo" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."sessoes_estudo" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."sessoes_treino" TO "anon";
GRANT ALL ON TABLE "public"."sessoes_treino" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."sessoes_treino" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."shape" TO "anon";
GRANT ALL ON TABLE "public"."shape" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."shape" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."simulados" TO "anon";
GRANT ALL ON TABLE "public"."simulados" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."simulados" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."treinos" TO "anon";
GRANT ALL ON TABLE "public"."treinos" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."treinos" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."trilha_sonora" TO "anon";
GRANT ALL ON TABLE "public"."trilha_sonora" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."trilha_sonora" TO "service_role";
